            ...
            <div class="slider__item swiper-slide">
                <div class="slider__item-description">
                    ...
                    <div class="slider__item-text">
                        Lorem ipsum dolor, sit amet consectetur adipisicing, elit. Ut quisquam eos rem quod ratione.
                        Quam odit dolor, aperiam labore neque quis adipisci dicta non, rem recusandae tempore quia id
                        quas voluptates ea vel atque doloribus explicabo maxime velit harum, accusantium.
                    </div>
        ...
        <section class="about">
            <div class="about__description">
                ...
                <div class="about__description_text">
                    <p>начал свою работу в 1999 году. С самого начала главной целью было предложить нашим клиентам самый
                        широкий спектр автомобильных запасных частей и аксессуаров, а развитие интернет–технологий дало
                        возможность максимально упростить и ускорить процесс покупки.</p>
                    <p>Компания быстро росла, и сегодня, занимая одну из ведущих позиции на этом рынке, мы не стоим на
                        месте. В основе проекта АвтоЗапчасти : самые современные информационные технологии, собственные
                        программные разработки, накопленная за годы работы аналитическая и статистическая информация по
                        рынку, высококвалифицированный коллектив — мы делаем все для того, чтобы Вы были довольны нашей
                        работой.</p>
                </div>
    ...
    <div class="news__wrapper">
        ...
        <div class="news__item">
            ...
            <div class="news__item_main">
                ...
                <div class="news__item_text">Рады сообщить, что в нашем интернет-магазине для заказа стали доступны
                    аксессуары для Chery Exeed TXL
                </div>
