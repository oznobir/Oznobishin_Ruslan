!function (e) {
    ...
    window.sizeCounter = function (e) {
        // this.$input = e.find(".js-counterValue"), this.count = Number(this.$input.val()), this.$plus = e.find(".js-counterIncrement"), this.$minus = e.find(".js-counterDecrement"), this.$show = e.find(".js-counterShow"), this.maximum = Number(e.data("max"));
        // var t = this;
        //
        // function i() {
